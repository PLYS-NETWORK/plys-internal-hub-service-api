...
> **Source:** [apps/business-service/src/modules/business-onboarding/controllers/business-onboarding.controller.ts](../../../../apps/business-service/src/modules/business-onboarding/controllers/business-onboarding.controller.ts)
...
- **Request body:** [`OnboardBusinessProfileDto`](../../../../apps/business-service/src/modules/business-onboarding/dto/requests/onboard-business-profile.dto.ts)
...
- **Service:** [BusinessOnboardingService](../../../../apps/business-service/src/modules/business-onboarding/services/business-onboarding.service.ts) — owns the onboarding step plus the per-platform tax-id conflict check.
- **Repository helper:** `uow.businessProfiles.existsTaxIdConflict({ taxId, countryCode, platform, excludeUserId? })` in [BusinessProfileRepository](../../../../packages/unit-of-work/repositories/profiles/business-profile.repository.ts) — joins `business_profiles → users` and filters by `users.platform`, `users.is_active`, `users.banned_at IS NULL`.
...
- **Entity:** [BusinessProfile](../../../../apps/business-service/src/database/entities/profiles/business-profile.entity.ts) — `tax_id` is `VARCHAR(32) NULL`; lookup-only index `idx_business_profiles_tax_id_country`.
- **Downstream notification:** `admin_business_onboarded` — see [admin events catalog](../../internal-admin-service/notifications/notifications-admin-events-api-specs.md) for the metadata shape + admin-side redirect URL.
