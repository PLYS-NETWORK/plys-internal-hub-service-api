...
export class NotificationsGrpcController extends GrpcBridgeBase {
  ...
  constructor(
    ...
    notificationInternalController: NotificationInternalController,
  ) {
    ...
    this.handlers = {
      ...createControllerBridgeHandlers(this, [
        ...
        {
          prefix: 'notificationInternal',
          instance: notificationInternalController,
          methods: {
            emit: (req): Promise<unknown[]> => Promise.resolve([this.parseJsonBody(req)]),
            dispatch: (req): Promise<unknown[]> => Promise.resolve([this.parseJsonBody(req)]),
          },
        },
      ]),
    };
