...
> **Source:** [src/modules/statistics/consultant/dashboard/consultant-dashboard.controller.ts](../../../../src/modules/statistics/consultant/dashboard/consultant-dashboard.controller.ts)
> **Base path:** `/consultant/dashboard`
...
- **Response 200:** [`IConsultantDashboardSummaryResponse`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)
  ...
  **`money`** ([`IConsultantDashboardMoney`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)):
  ...
  **`portfolio`** ([`IConsultantDashboardPortfolio`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)):
  ...
  **`performance`** ([`IConsultantDashboardPerformance`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)):
  ...
  **`skills`** ([`IConsultantDashboardSkills`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)):
  ...
  **`exams`** ([`IConsultantDashboardExams`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)):
  ...
  **`onboarding`** ([`IConsultantDashboardOnboarding`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)):
  ...
  **`action_counts`** ([`IConsultantDashboardActionCounts`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-dashboard-summary.response.interface.ts)):
...
- **Response 200:** [`IConsultantActionItemsResponse`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-action-items.response.interface.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`ConsultantEarningsTrendDto`](../../../../src/modules/statistics/dto/requests/consultant-earnings-trend.dto.ts)
...
- **Response 200:** [`IConsultantEarningsTrendResponse`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-earnings-trend.response.interface.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`ConsultantProjectProgressDto`](../../../../src/modules/statistics/dto/requests/consultant-project-progress.dto.ts)
...
- **Response 200:** [`IConsultantProjectProgressResponse`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-project-progress.response.interface.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`ConsultantSkillPerformanceDto`](../../../../src/modules/statistics/dto/requests/consultant-skill-performance.dto.ts)
...
- **Response 200:** [`IConsultantSkillPerformanceResponse`](../../../../src/modules/statistics/dto/responses/interfaces/consultant-skill-performance.response.interface.ts)
