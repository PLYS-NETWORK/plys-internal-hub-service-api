...
import {
  GetMilestonesDto,
  ListBoardTasksDto,
} from '@plys/libraries/api-contracts/business-projects/dto/requests';
import {
  BoardResultResponseDto,
  BoardTaskDetailResponseDto,
  BoardTaskHistoryResponseDto,
  BoardTaskResponseDto,
} from '@plys/libraries/api-contracts/business-projects/dto/responses';
import { BoardMilestonesResponseDto } from '@plys/libraries/api-contracts/business-projects/dto/responses/board-milestones-response.dto';
...
@ApiBearerAuth()
@Controller('business/projects/:id/board')
