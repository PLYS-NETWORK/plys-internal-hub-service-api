...
import { AiSyncSettingsDto } from '@plys/libraries/api-contracts/business-projects/dto/requests/ai-sync-settings.dto';
import { AiSyncSkillsDto } from '@plys/libraries/api-contracts/business-projects/dto/requests/ai-sync-skills.dto';
import { AiSyncTasksDto } from '@plys/libraries/api-contracts/business-projects/dto/requests/ai-sync-tasks.dto';
import { ProjectSummaryResponseDto } from '@plys/libraries/api-contracts/business-projects/dto/responses';
import { AiSyncTasksResponseDto } from '@plys/libraries/api-contracts/business-projects/dto/responses/ai-sync-tasks-response.dto';
...
import { BacklogsService, SettingsService } from '@/http/v1/shared/grpc-service-tokens';
...
@ApiTags('Business Projects — AI Sync')
@ApiBearerAuth()
@Controller('business/projects/:id/ai-sync')
