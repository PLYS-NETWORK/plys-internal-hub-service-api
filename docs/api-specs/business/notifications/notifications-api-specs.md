...
> **Realtime companion:** the live `notification.new` socket payload mirrors `NotificationResponseDto` exactly — see [notifications-realtime-api-specs.md](../../shared/notifications-realtime-api-specs.md).
