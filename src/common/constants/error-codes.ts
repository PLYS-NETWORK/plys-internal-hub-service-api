...
export const ERROR_CODES = {
  ...
  // ─── Application ─────────────────────────────────────────────────────────
  APPLICATION_PROJECT_NOT_ACCEPTING: 'APPLICATION_PROJECT_NOT_ACCEPTING',
  APPLICATION_ALREADY_APPLIED: 'APPLICATION_ALREADY_APPLIED',
  APPLICATION_NO_MATCHING_SKILLS: 'APPLICATION_NO_MATCHING_SKILLS',
  APPLICATION_MISSING_ANSWERS: 'APPLICATION_MISSING_ANSWERS',
  APPLICATION_AI_DETECTED: 'APPLICATION_AI_DETECTED',
  APPLICATION_AI_CHECK_FAILED: 'APPLICATION_AI_CHECK_FAILED',
  APPLICATION_COVER_LETTER_REQUIRED: 'APPLICATION_COVER_LETTER_REQUIRED',
  APPLICATION_NOT_FOUND: 'APPLICATION_NOT_FOUND',
  APPLICATION_CANNOT_APPROVE: 'APPLICATION_CANNOT_APPROVE',
  APPLICATION_CANNOT_REJECT: 'APPLICATION_CANNOT_REJECT',
  ...
  TASK_CONSULTANT_NOT_PROJECT_MEMBER: 'TASK_CONSULTANT_NOT_PROJECT_MEMBER',
  TASK_PROJECT_NOT_IN_PROGRESS: 'TASK_PROJECT_NOT_IN_PROGRESS',
  TASK_COMMENT_NOT_FOUND: 'TASK_COMMENT_NOT_FOUND',
  TASK_COMMENT_FORBIDDEN: 'TASK_COMMENT_FORBIDDEN',
  TASK_COMMENT_FILE_NOT_OWNED: 'TASK_COMMENT_FILE_NOT_OWNED',
  TASK_COMMENT_EMPTY_UPDATE: 'TASK_COMMENT_EMPTY_UPDATE',
