...
class TransactionalUnitOfWork implements IUnitOfWork {
  constructor(
    ...
    public readonly taskEvidences: ITaskEvidenceRepository,
    public readonly taskEvidenceAttachments: ITaskEvidenceAttachmentRepository,
...
export class UnitOfWorkService implements IUnitOfWork {
  constructor(
    ...
    public readonly taskEvidences: TaskEvidenceRepository,
    public readonly taskEvidenceAttachments: TaskEvidenceAttachmentRepository,
    // Domain 5 — AI
  ...
  public async withTransaction<T>(work: (uow: IUnitOfWork) => Promise<T>): Promise<T> {
    ...
    try {
      ...
      const txUow = new TransactionalUnitOfWork(
        ...
        this.taskEvidences.withManager(manager),
        this.taskEvidenceAttachments.withManager(manager),
