...
> Source: [apps/api-gateway/src/http/v1/notifications/notifications.gateway.ts](../../../apps/api-gateway/src/http/v1/notifications/notifications.gateway.ts)
...
> Companion REST spec: [notifications-api-specs.md](../business-service/notifications/notifications-api-specs.md) (same controller is shared across business / consultant / admin frontends — gated on `@Roles(UserRole.USER, UserRole.ADMIN_PLATFORM)`).
>
> **Role-specific event catalogs (metadata shapes, redirect URLs, cache-invalidation hints):**
>
> - Admin platform → [notifications-admin-events.md](../internal-admin-service/notifications/notifications-admin-events-api-specs.md)
> - Business platform → [notifications-business-events.md](../business-service/notifications/notifications-business-events-api-specs.md)
> - Consultant platform → [notifications-consultant-events.md](../consultant-service/notifications/notifications-consultant-events-api-specs.md)
...
notifications-service emits live events with **`@socket.io/redis-emitter`** directly
...
Mirrors [apps/notifications-service/apps/notifications-service/src/modules/notifications/types/notification-metadata.types.ts](../../../apps/notifications-service/apps/notifications-service/src/modules/notifications/types/notification-metadata.types.ts).
...
notifications-service emits via `@socket.io/redis-emitter` into the recipient room.
