import { IDownloadHandle, IUploadInput } from '@plys/libraries/common-nest/modules/file-storage';
 ...
 * `IStorageProvider` (from `@plys/libraries/common-nest/modules/file-storage`) with persistence
 * and access control.
 */
