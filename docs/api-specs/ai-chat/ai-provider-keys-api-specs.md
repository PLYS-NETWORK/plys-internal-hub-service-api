...
> **Sources:**
>
> - BFF endpoint: [src/modules/ai-provider-key/ai-provider-key-bff.controller.ts](../../../src/modules/ai-provider-key/ai-provider-key-bff.controller.ts)
> - Admin CRUD: [src/modules/ai-provider-key/ai-provider-key-admin.controller.ts](../../../src/modules/ai-provider-key/ai-provider-key-admin.controller.ts)
> - Service: [src/modules/ai-provider-key/ai-provider-key.service.ts](../../../src/modules/ai-provider-key/ai-provider-key.service.ts)
> - Crypto: [crypto/aes-gcm.ts](../../../src/modules/ai-provider-key/crypto/aes-gcm.ts), [crypto/master-key.cipher.ts](../../../src/modules/ai-provider-key/crypto/master-key.cipher.ts), [crypto/bff-envelope.cipher.ts](../../../src/modules/ai-provider-key/crypto/bff-envelope.cipher.ts)
>
...
- **Request body:** [`IUpdateApiKeyRequest`](../../../src/modules/ai-provider-key/dto/requests/interfaces/update-api-key.request.interface.ts) — both fields optional.
  | Field | Type | Required | Notes |
  | ------- | -------- | -------- | ----- |
