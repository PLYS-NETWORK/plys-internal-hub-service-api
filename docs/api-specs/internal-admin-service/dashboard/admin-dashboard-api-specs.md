...
> **Source:** [apps/internal-admin-service/src/modules/statistics/admin/admin-statistics.controller.ts](../../../../apps/internal-admin-service/src/modules/statistics/admin/admin-statistics.controller.ts)
...
- **Response 200:** [`IAdminDashboardSummaryResponse`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-dashboard-summary.response.interface.ts)
  ...
  **`users.business` and `users.consultant`** ([`IAdminUsersStatusCounts`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-dashboard-summary.response.interface.ts)):
  ...
  **`financial`** ([`IAdminFinancialSummary`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-dashboard-summary.response.interface.ts)):
  ...
  **`queues`** ([`IAdminOperationalQueuesSummary`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-dashboard-summary.response.interface.ts)):
  ...
  **`growth`** ([`IAdminGrowthSummary`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-dashboard-summary.response.interface.ts)):
...
- **Response 200:** [`IAdminUsersBreakdownResponse`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-users-breakdown.response.interface.ts) — same shape as `summary.users` (`business` + `consultant` blocks, both `IAdminUsersStatusCounts`). See the table in §1.
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`AdminGrowthTrendDto`](../../../../apps/internal-admin-service/src/modules/statistics/dto/requests/admin-growth-trend.dto.ts)
...
- **Response 200:** [`IAdminGrowthTrendResponse`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-growth-trend.response.interface.ts)
  ...
  **`points[]`** ([`IAdminGrowthTrendPoint`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-growth-trend.response.interface.ts)):
...
- **Response 200:** [`IAdminOperationalQueuesResponse`](../../../../apps/internal-admin-service/src/modules/statistics/dto/responses/interfaces/admin-operational-queues.response.interface.ts)
