...
class TransactionalUnitOfWork implements IUnitOfWork {
  constructor(
    ...
    public readonly consultantOnboardingQuestions: IConsultantOnboardingQuestionRepository,
...
export class UnitOfWorkService implements IUnitOfWork {
  constructor(
    ...
    public readonly consultantOnboardingQuestions: ConsultantOnboardingQuestionRepository,
  ...
  public async withTransaction<T>(work: (uow: IUnitOfWork) => Promise<T>): Promise<T> {
    ...
    try {
      ...
      const txUow = new TransactionalUnitOfWork(
        ...
        this.consultantOnboardingQuestions.withManager(manager),
