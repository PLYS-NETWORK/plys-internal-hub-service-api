...
import { ListOnboardingsDto } from '@plys/libraries/api-contracts/admin-consultant-onboarding/dto/requests/list-onboardings.dto';
import { OnboardingDecisionDto } from '@plys/libraries/api-contracts/admin-consultant-onboarding/dto/requests/onboarding-decision.dto';
import { OnboardingDetailResponseDto } from '@plys/libraries/api-contracts/admin-consultant-onboarding/dto/responses/onboarding-detail-response.dto';
import { PaginatedOnboardingsResponseDto } from '@plys/libraries/api-contracts/admin-consultant-onboarding/dto/responses/onboarding-list-item-response.dto';
...
import { AdminConsultantOnboardingService } from '@/http/v1/shared/grpc-service-tokens';
