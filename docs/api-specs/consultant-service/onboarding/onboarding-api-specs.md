...
> **Source:**
> [apps/consultant-service/src/modules/consultant-onboarding/controllers/consultant-onboarding.controller.ts](../../../../apps/consultant-service/src/modules/consultant-onboarding/controllers/consultant-onboarding.controller.ts)
...
- **Response 201:** [`FileResponseDto`](../../../../apps/consultant-service/src/modules/files/dto/responses/file-response.dto.ts) — keep the `url` and pass it as `cv_url` or `avatar_url` to the profile submission below.
...
- **Body:** [`SubmitOnboardingProfileDto`](../../../../apps/consultant-service/src/modules/consultant-onboarding/dto/requests/submit-onboarding-profile.dto.ts)
...
- **Response 200:** [`OnboardingQuestionResponseDto[]`](../../../../apps/consultant-service/src/modules/consultant-onboarding/dto/responses/onboarding-question-response.dto.ts)
...
- **Body:** [`SubmitOnboardingAnswersDto`](../../../../apps/consultant-service/src/modules/consultant-onboarding/dto/requests/submit-onboarding-answers.dto.ts)
