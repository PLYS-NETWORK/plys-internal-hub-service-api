...
export { IBusinessTransactionRepository } from './business-transaction.repository.interface';
export { IConsultantWalletRepository } from './consultant-wallet.repository.interface';
...
export { IWalletTransactionRepository } from './wallet-transaction.repository.interface';
