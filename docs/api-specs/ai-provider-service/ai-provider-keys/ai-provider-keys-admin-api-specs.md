...
> **Sources**
>
> - Controller: [apps/ai-provider-service/src/modules/ai-provider-key/ai-provider-key-admin.controller.ts](../../../../apps/ai-provider-service/src/modules/ai-provider-key/ai-provider-key-admin.controller.ts)
...
> - Request DTOs: [create-api-key.dto.ts](../../../../apps/ai-provider-service/src/modules/ai-provider-key/dto/requests/create-api-key.dto.ts), [update-api-key.dto.ts](../../../../apps/ai-provider-service/src/modules/ai-provider-key/dto/requests/update-api-key.dto.ts)
> - Response DTO: [api-key-admin-response.dto.ts](../../../../apps/ai-provider-service/src/modules/ai-provider-key/dto/responses/api-key-admin-response.dto.ts)
>
