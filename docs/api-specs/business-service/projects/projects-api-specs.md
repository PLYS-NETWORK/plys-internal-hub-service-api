...
> **Source:** [apps/business-service/src/modules/business-projects/controllers/projects.controller.ts](../../../../apps/business-service/src/modules/business-projects/controllers/projects.controller.ts)
...
| 403  | `BUSINESS_PROFILE_NOT_FOUND`                  | Caller has no active business profile — thrown by [BusinessAccessService.resolveBusinessProfile](../../../../apps/business-service/src/modules/business-projects/services/business-access.service.ts).                                    |
| 403  | `PROJECT_FORBIDDEN` / 404 `PROJECT_NOT_FOUND` | Project not owned by the caller — thrown by [BusinessAccessService.resolveOwnedProject](../../../../apps/business-service/src/modules/business-projects/services/business-access.service.ts). Applies to every endpoint that takes `:id`. |
...
- **Request body:** [`ICreateProjectRequest`](../../../../apps/business-service/src/modules/business-projects/dto/requests/interfaces/create-project.request.interface.ts)
...
- **Response 200:** [`IProjectSearchItemResponse[]`](../../../../apps/business-service/src/modules/business-projects/dto/responses/interfaces/project-search-item.response.interface.ts) — plain array of `{ id, code, title }`. No `PageDto` envelope; the standard response wrapper's `data` field holds the array directly.
...
- **Path params:** `id` (UUID v4)
- **Request body:** [`TransitionProjectStatusDto`](../../../../apps/business-service/src/modules/business-projects/dto/requests/transition-project-status.dto.ts)
  | Field | Type | Required | Notes |
  | -------- | ------------------------ | -------- | ----- |
...
- **Behaviour:** [BusinessProjectsService.transitionStatus](../../../../apps/business-service/src/modules/business-projects/services/projects/projects.service.ts):
...
- **Response 200:** [`IProjectSummaryResponse`](../../../../apps/business-service/src/modules/business-projects/dto/responses/interfaces/project-summary.response.interface.ts) — final project metadata with `status = 'configured'`.
- **Errors:**
  | HTTP | error_code | When |
  | ---- | ---------- | ---- |
