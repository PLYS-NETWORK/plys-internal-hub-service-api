...
import { ListBusinessProfilesDto } from '@plys/libraries/api-contracts/profiles/dto/requests/list-business-profiles.dto';
import { SetBooleanFlagDto } from '@plys/libraries/api-contracts/profiles/dto/requests/set-boolean-flag.dto';
import { AdminBusinessProfileDetailResponseDto } from '@plys/libraries/api-contracts/profiles/dto/responses/admin-business-profile-detail-response.dto';
import { AdminBusinessProfileListItemResponseDto } from '@plys/libraries/api-contracts/profiles/dto/responses/admin-business-profile-list-item-response.dto';
...
import { BusinessProfilesAdminService } from '@/http/v1/shared/grpc-service-tokens';
...
@ApiBearerAuth()
@Controller('admin/profiles/business')
