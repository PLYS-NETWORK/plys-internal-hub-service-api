...
> **Source:**
> [src/modules/admin-onboarding-questions/controllers/admin-onboarding-questions.controller.ts](../../../../src/modules/admin-onboarding-questions/controllers/admin-onboarding-questions.controller.ts)
...
- **Body:** [`CreateOnboardingQuestionDto`](../../../../src/modules/admin-onboarding-questions/dto/requests/create-onboarding-question.dto.ts)
...
- **Response 201:** [`OnboardingQuestionResponseDto`](../../../../src/modules/admin-onboarding-questions/dto/responses/onboarding-question-response.dto.ts)
...
- **Response 200:** [`PageDto<OnboardingQuestionResponseDto>`](../../../../src/common/dto/page.dto.ts)
...
- **Path params:** `id` (UUID v4)
- **Body:** [`UpdateOnboardingQuestionDto`](../../../../src/modules/admin-onboarding-questions/dto/requests/update-onboarding-question.dto.ts) — all fields optional.
...
- **Path params:** `id` (UUID v4)
- **Body:** [`SetActiveFlagDto`](../../../../src/modules/admin-onboarding-questions/dto/requests/set-active.dto.ts)
...
- **Body:** [`ReorderOnboardingQuestionsDto`](../../../../src/modules/admin-onboarding-questions/dto/requests/reorder-onboarding-questions.dto.ts)
