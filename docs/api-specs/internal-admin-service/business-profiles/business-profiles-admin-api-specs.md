...
> **Source:** [apps/api-gateway/src/http/v1/business/controllers/business-profiles-admin.controller.ts](../../../../apps/api-gateway/src/http/v1/business/controllers/business-profiles-admin.controller.ts)
> **Service DTOs:** [apps/business-service/src/modules/profiles/dto](../../../../apps/business-service/src/modules/profiles/dto)
> **Base path:** `/api/v1/admin/business-profiles`
...
- **Method:** `GET`
- **Query params:** [`ListBusinessProfilesDto`](../../../../apps/internal-admin-service/src/modules/profiles/business/dto/requests/list-business-profiles.dto.ts) (extends [`PageOptionsDto`](../../../../packages/common-nest/dto/page-options.dto.ts))
...
- **Response 200:** `PageDto<`[`IAdminBusinessProfileListItemResponse`](../../../../apps/internal-admin-service/src/modules/profiles/business/dto/responses/interfaces/admin-business-profile-list-item.response.interface.ts)`>`
...
- **Response 200:** [`IAdminBusinessProfileDetailResponse`](../../../../apps/internal-admin-service/src/modules/profiles/business/dto/responses/interfaces/admin-business-profile-detail.response.interface.ts) — superset of the user-scoped [`IBusinessProfileResponse`](../../../../apps/internal-admin-service/src/modules/profiles/business/dto/responses/interfaces/business-profile.response.interface.ts) plus `email`, `register_date`, `last_login`.
...
- **Request body:** [`SetBooleanFlagDto`](../../../../apps/internal-admin-service/src/modules/profiles/business/dto/requests/set-boolean-flag.dto.ts)
  | Field | Type | Required | Notes |
  |-------|------|----------|-------|
...
- **Service:** [BusinessProfilesAdminService](../../../../apps/internal-admin-service/src/modules/profiles/business/business-profiles-admin.service.ts) — owns the QueryBuilder for the join, the `SORT_COLUMN_MAP` whitelist, and the bidirectional setters.
- **Repository accessor:** `uow.businessProfiles` from [UnitOfWorkService](../../../../packages/unit-of-work/unit-of-work.service.ts).
- **User-scoped surface (separate controller):** [`BusinessProfilesController`](../../../../apps/internal-admin-service/src/modules/profiles/business/business-profiles.controller.ts) — the `/business-profiles` routes used by business owners (get/update own profile). Onboarding moved to [`BusinessOnboardingController`](../../../../apps/internal-admin-service/src/modules/business-onboarding/controllers/business-onboarding.controller.ts) — see [`business onboarding`](../../business-service/onboarding/onboarding-api-specs.md).
...
- **Admin controller convention precedent:** [`AiProviderKeyAdminController`](../../../../apps/internal-admin-service/src/modules/ai-provider-key/ai-provider-key-admin.controller.ts) — same shape (`@Controller('admin/...')`, class-level `@Roles(UserRole.ADMIN_PLATFORM)`, no `@Platform`).
