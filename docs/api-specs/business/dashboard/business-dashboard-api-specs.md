...
> **Source:** [src/modules/statistics/business/dashboard/business-dashboard.controller.ts](../../../../src/modules/statistics/business/dashboard/business-dashboard.controller.ts)
> **Base path:** `/business/dashboard`
...
- **Response 200:** [`IBusinessDashboardSummaryResponse`](../../../../src/modules/statistics/dto/responses/interfaces/business-dashboard-summary.response.interface.ts)
  ...
  **`money`** ([`IBusinessDashboardMoney`](../../../../src/modules/statistics/dto/responses/interfaces/business-dashboard-summary.response.interface.ts)):
  ...
  **`portfolio`** ([`IBusinessDashboardPortfolio`](../../../../src/modules/statistics/dto/responses/interfaces/business-dashboard-summary.response.interface.ts)):
  ...
  **`throughput`** ([`IBusinessDashboardThroughput`](../../../../src/modules/statistics/dto/responses/interfaces/business-dashboard-summary.response.interface.ts)):
  ...
  **`team`** ([`IBusinessDashboardTeam`](../../../../src/modules/statistics/dto/responses/interfaces/business-dashboard-summary.response.interface.ts)):
  ...
  **`action_counts`** ([`IBusinessDashboardActionCounts`](../../../../src/modules/statistics/dto/responses/interfaces/business-dashboard-summary.response.interface.ts)):
...
- **Response 200:** [`IBusinessActionItemsResponse`](../../../../src/modules/statistics/dto/responses/interfaces/business-action-items.response.interface.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`BusinessSpendTrendDto`](../../../../src/modules/statistics/dto/requests/business-spend-trend.dto.ts)
...
- **Response 200:** [`IBusinessSpendTrendResponse`](../../../../src/modules/statistics/dto/responses/interfaces/business-spend-trend.response.interface.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`BusinessProjectHealthDto`](../../../../src/modules/statistics/dto/requests/business-project-health.dto.ts)
...
- **Response 200:** [`IBusinessProjectHealthResponse`](../../../../src/modules/statistics/dto/responses/interfaces/business-project-health.response.interface.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`BusinessTeamPerformanceDto`](../../../../src/modules/statistics/dto/requests/business-team-performance.dto.ts)
...
- **Response 200:** [`IBusinessTeamPerformanceResponse`](../../../../src/modules/statistics/dto/responses/interfaces/business-team-performance.response.interface.ts)
