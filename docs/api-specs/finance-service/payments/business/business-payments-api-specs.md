...
> **Source:** [apps/finance-service/src/modules/payments/business/business-payments.controller.ts](../../../../apps/finance-service/src/modules/payments/business/business-payments.controller.ts)
> **Base path:** `/api/v1/payments/business`
...
| 403  | `BUSINESS_PROFILE_NOT_FOUND` | Caller's `activePlatform` is not `BUSINESS` or no active business profile exists for the user — thrown by [BusinessPaymentsService](../../../../apps/finance-service/src/modules/payments/business/business-payments.service.ts). |
...
- **Method:** `POST`
- **Status:** `201 Created`
- **Request body:** [`ICreateTopUpRequest`](../../../../apps/finance-service/src/modules/payments/dto/requests/interfaces/create-top-up.request.interface.ts)
  ...
  **`payer_info`** ([`IPayerInfoRequest`](../../../../apps/finance-service/src/modules/payments/dto/requests/interfaces/payer-info.request.interface.ts)):
  ...
  **`billing_address`** ([`IBillingAddressRequest`](../../../../apps/finance-service/src/modules/payments/dto/requests/interfaces/billing-address.request.interface.ts)):
...
- **Response 201:** [`ITopUpResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/top-up.response.interface.ts)
...
- **Response 200:** [`ITopUpResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/top-up.response.interface.ts)
...
- **Response 200:** [`ICancelTopUpResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/cancel-top-up.response.interface.ts)
...
- **Method:** `POST`
- **Status:** `201 Created`
- **Request body:** [`ISettleInvoiceRequest`](../../../../apps/finance-service/src/modules/payments/dto/requests/interfaces/settle-invoice.request.interface.ts)
...
- **Response 201:** [`ISettleInvoiceResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/settle-invoice.response.interface.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`ListBusinessTransactionsDto`](../../../../apps/finance-service/src/modules/payments/dto/requests/list-business-transactions.dto.ts) (extends `PageOptionsDto`)
...
- **Response 200:** `PageDto<`[`ITransactionResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/transaction.response.interface.ts)`>`
