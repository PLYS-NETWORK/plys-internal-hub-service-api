...
> **Source:** [apps/finance-service/src/modules/payments/admin/admin-payments.controller.ts](../../../../apps/finance-service/src/modules/payments/admin/admin-payments.controller.ts)
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`AdminListConsultantTransactionsDto`](../../../../apps/finance-service/src/modules/payments/dto/requests/admin-list-consultant-transactions.dto.ts) (extends `PageOptionsDto`)
...
- **Response 200:** `PageDto<`[`IAdminConsultantTransactionResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/admin-consultant-transaction.response.interface.ts)`>`
  ...
  **`owner`** ([`IAdminTransactionOwnerResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/admin-transaction-owner.response.interface.ts)):
...
- **Method:** `GET`
- **Status:** `200 OK`
- **Query params:** [`AdminListBusinessTransactionsDto`](../../../../apps/finance-service/src/modules/payments/dto/requests/admin-list-business-transactions.dto.ts) (extends `PageOptionsDto`)
...
- **Response 200:** `PageDto<`[`IAdminBusinessTransactionResponse`](../../../../apps/finance-service/src/modules/payments/dto/responses/interfaces/admin-business-transaction.response.interface.ts)`>`
  ...
  **Item fields:**
  ...
  | `status`             | `TransactionStatus`       | no       | Current processing status.                                                                                                                                                                                                                                                       |
  | `note`               | `string`                  | yes      | Human-readable description; `null` when absent.                                                                                                                                                                                                                                  |
  | `payer_info`         | `PayerInfo`               | yes      | Payer snapshot stored at checkout creation; `null` for internal ledger entries that never went through Polar (e.g. `project_published`, `task_added`). See the [business-payments spec §1](../../business-service/payments/business-payments-api-specs.md) for the nested shape. |
  | `created_at`         | `ISO 8601`                | no       | Timestamp rendered in the admin caller's session timezone (falls back to `UTC`). Offset included, e.g. `2026-04-20T19:00:00.000+07:00`.                                                                                                                                          |
