...
import { StartSkillExamDto } from '@plys/libraries/api-contracts/consultant-skill-exam/dto/requests/start-skill-exam.dto';
import { SubmitSkillExamAnswerDto } from '@plys/libraries/api-contracts/consultant-skill-exam/dto/requests/submit-skill-exam-answer.dto';
import { SkillExamDetailResponseDto } from '@plys/libraries/api-contracts/consultant-skill-exam/dto/responses/skill-exam-detail-response.dto';
import { SkillExamEligibilityResponseDto } from '@plys/libraries/api-contracts/consultant-skill-exam/dto/responses/skill-exam-eligibility-response.dto';
import { SkillExamSummaryResponseDto } from '@plys/libraries/api-contracts/consultant-skill-exam/dto/responses/skill-exam-summary-response.dto';
...
import { ConsultantSkillExamService } from '@/http/v1/shared/grpc-service-tokens';
