...
import { UpdateProjectSettingsDto } from '@plys/libraries/api-contracts/business-projects/dto/requests';
import {
...
import { SettingsService } from '@/http/v1/shared/grpc-service-tokens';

@ApiTags('Business Projects — Settings')
@ApiBearerAuth()
@Controller('business/projects/:id/settings')
