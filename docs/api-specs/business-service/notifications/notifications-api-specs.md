...
> **Source:** [apps/business-service/src/modules/notifications/notifications.controller.ts](../../../../apps/business-service/src/modules/notifications/notifications.controller.ts)
...
> **Realtime companion:** the live `notification.new` socket payload mirrors `NotificationResponseDto` exactly — see [notifications-realtime-api-specs.md](../../notifications-service/notifications-realtime-api-specs.md).
...
- **Method:** `GET`
- **Query params:** [`ListNotificationsDto`](../../../../apps/business-service/src/modules/notifications/dto/requests/list-notifications.dto.ts)
...
- **Response 200:** `NotificationCursorPageDto`
  ...
  Each item is a [`NotificationResponseDto`](../../../../apps/business-service/src/modules/notifications/dto/responses/notification-response.dto.ts) — see §Appendix for one worked example per `type`.
...
- **Method:** `GET`
- **Response 200:** [`UnreadCountResponseDto`](../../../../apps/business-service/src/modules/notifications/dto/responses/unread-count-response.dto.ts)
  ```json
  { "unread_count": 7 }
  ```
...
- **Response 200:** [`NotificationResponseDto`](../../../../apps/business-service/src/modules/notifications/dto/responses/notification-response.dto.ts) — the (now-read) notification.
...
- **Method:** `PATCH`
- **Response 200:** [`MarkAllReadResponseDto`](../../../../apps/business-service/src/modules/notifications/dto/responses/mark-all-read-response.dto.ts)
  ```json
  { "updated_count": 7 }
  ```
...
[`NotificationPayload`](../../../../apps/business-service/src/modules/notifications/types/notification-metadata.types.ts) discriminated union
