...
> **Source:** [apps/consultant-service/src/modules/profiles/consultant/consultant-profiles.controller.ts](../../../../apps/consultant-service/src/modules/profiles/consultant/consultant-profiles.controller.ts)
> **Base path:** `/api/v1/consultant-profiles`
...
> **Onboarding is separate.** The basic-info onboarding submission lives in [`consultant onboarding`](../onboarding/onboarding-api-specs.md) (`POST /consultant/onboarding/profile`). This spec covers post-onboarding self-service routes only.
...
- **Method:** `PATCH`
- **Status on success:** `200 OK`
- **Request body:** [`UpdateConsultantProfileDto`](../../../../apps/consultant-service/src/modules/profiles/consultant/dto/requests/update-consultant-profile.dto.ts) — every field is optional.
...
Source: [`ConsultantProfileResponseDto`](../../../../apps/consultant-service/src/modules/profiles/consultant/dto/responses/consultant-profile-response.dto.ts)
...
- **Onboarding (separate module):** [`POST /consultant/onboarding/profile`](../onboarding/onboarding-api-specs.md) — submits the first-time consultant profile + transitions onboarding to `IN_INTERVIEW`.
- **Service:** [ConsultantProfilesService](../../../../apps/consultant-service/src/modules/profiles/consultant/consultant-profiles.service.ts) — owns profile fetch + partial update (transactional skill-set replace).
- **Repository accessor:** `uow.consultantProfiles` and `uow.consultantSkills` from [UnitOfWorkService](../../../../packages/unit-of-work/unit-of-work.service.ts).
- **Entity:** [ConsultantProfile](../../../../apps/consultant-service/src/database/entities/profiles/consultant-profile.entity.ts) — one profile per user; `uq_consultant_profiles_user_id` enforces uniqueness at the DB level.
