...
> **Source:** [src/modules/explore/explore.controller.ts](../../../src/modules/explore/explore.controller.ts)
> **Base path:** `/explore`
> **Scope (applies to every endpoint):** `@Public()` skips the global `JwtAuthGuard`; **controller-scoped** [`ExploreApiKeyGuard`](../../../src/modules/explore/guards/explore-api-key.guard.ts) enforces a shared secret presented via the `x-api-key` header. No user identity is required or read.
...
- **Response 200:** [`IExploreSkillResponse[]`](../../../src/modules/explore/dto/responses/interfaces/explore-skill.response.interface.ts)
...
- **Response 200:** [`IExploreProjectDetailResponse`](../../../src/modules/explore/dto/responses/interfaces/explore-project-detail.response.interface.ts)
