...
import { ExploreSkillResponseDto } from './explore-skill-response.dto';
import { IExploreProjectDetailResponse } from './interfaces/explore-project-detail.response.interface';

@Exclude()
export class ExploreProjectDetailResponseDto implements IExploreProjectDetailResponse {
  @Expose()
  ...
  @Expose()
  @ApiProperty({ name: 'required_skills', type: () => ExploreSkillResponseDto, isArray: true })
  @Type(() => ExploreSkillResponseDto)
  public readonly required_skills!: ExploreSkillResponseDto[];
