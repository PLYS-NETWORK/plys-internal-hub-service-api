...
| Method   | Path                                        | Spec                                                      |
| -------- | ------------------------------------------- | --------------------------------------------------------- |
| `POST`   | `/projects/business/:id/backlogs`           | [backlogs](../business/projects/backlogs-api-specs.md)    |
| `PATCH`  | `/projects/business/:id/backlogs/:taskId`   | [backlogs](../business/projects/backlogs-api-specs.md)    |
| `DELETE` | `/projects/business/:id/backlogs`           | [backlogs](../business/projects/backlogs-api-specs.md)    |
| `PATCH`  | `/projects/business/:id/settings`           | [settings](../business/projects/settings-api-specs.md)    |
| `PATCH`  | `/projects/business/:id/status`             | [projects](../business/projects/projects-api-specs.md)    |
| `POST`   | `/projects/business/:id/ai-sync/settings`   | [ai-sync](../business/projects/ai-sync-api-specs.md)      |
| `POST`   | `/projects/business/:id/ai-sync/skills`     | [ai-sync](../business/projects/ai-sync-api-specs.md)      |
| `POST`   | `/projects/business/:id/ai-sync/tasks`      | [ai-sync](../business/projects/ai-sync-api-specs.md)      |
| `POST`   | `/projects/:projectId/ai-context/decisions` | [ai-context](../business/ai-chat/ai-context-api-specs.md) |
